<template>
  <div
    class="embed-projects"
    :class="[$env.INSTANCE_ID + '-projects', { 'is-responsive': responsive }]"
    @click.stop="clickInside"
  >
    <div class="embed-projects-search">
      <div class="embed-projects-search-input">
        <input
          type="text"
          :placeholder="$t('Suchbegriff', locale)"
          v-model="term"
        ...
        />
        <div
          class="embed-projects-search-input-icon"
          @click.stop="
            term = null;
            changeSearchTerm();
          "
    ...
    <div class="embed-projects-filters">
      <div class="embed-projects-filters-select" data-filter-type="states">
        ...
        <div
          ...
          :class="{ 'is-active': activeFilterSelect === 'state' }"
        ></div>
        ...
        <transition name="embed-projects-filters-select-options" mode="out-in">
          ...
          >
            ...
            <div
              ...
              :class="{
                'is-selected': isFilterSelected({ type: 'state', entity: state }),
              }"
              @click.stop="clickToggleFilter({ type: 'state', entity: state })"
            >
              {{ translateField(state, "name", locale) }}
              <div
                v-if="templateHook('filterSelectOptionsItemAfter', 'state', state)"
              ></div>
            </div>
          </div>
        </transition>
      ...
      <div class="embed-projects-filters-select" data-filter-type="topics">
        ...
        <div
          class="embed-projects-filters-select-icon"
          :class="{ 'is-active': activeFilterSelect === 'topic' }"
        ></div>
        ...
        <transition name="embed-projects-filters-select-options" mode="out-in">
          ...
          >
            <div
              ...
              :class="{
                'is-selected': isFilterSelected({ type: 'topic', entity: topic }),
              }"
              @click.stop="clickToggleFilter({ type: 'topic', entity: topic })"
            >
              {{ translateField(topic, "name", locale) }}
              <div
                v-if="templateHook('filterSelectOptionsItemAfter', 'topic', topic)"
              ></div>
            </div>
          </div>
        </transition>
      ...
      <!-- <div class="embed-projects-filters-select" data-filter-type="programs">
        ...
        <div
          class="embed-projects-filters-select-icon"
          :class="{ 'is-active': activeFilterSelect === 'program' }"
        ></div>
        ...
        <transition name="embed-projects-filters-select-options" mode="out-in">
          ...
          >
            <div
              ...
              :class="{
                'is-selected': isFilterSelected({ type: 'program', entity: program }),
              }"
              @click.stop="clickToggleFilter({ type: 'program', entity: program })"
            >
              {{
                translateField(program, "longName", locale) ||
                translateField(program, "name", locale)
              }}
              <div
                v-if="templateHook('filterSelectOptionsItemAfter', 'program', program)"
              ></div>
              <template v-else-if="translateField(program, 'url', locale)">
                <a
                  class="embed-projects-filters-select-options-item-icon"
      ...
      <div class="embed-projects-filters-select" data-filter-type="startDates">
        <div
          class="embed-projects-filters-select-label"
          @click.stop="clickFilterSelect('startDate')"
        >
          {{ $t("Projektstart", locale) }}
        </div>

        <div
          class="embed-projects-filters-select-icon"
          :class="{ 'is-active': activeFilterSelect === 'startDate' }"
        ></div>
        ...
        <transition name="embed-projects-filters-select-options" mode="out-in">
          ...
          >
            <div
              ...
              :class="{
                'is-selected': isFilterSelected({ type: 'startDate', entity: startDate }),
              }"
            ...
            >
              ...
              <div
                v-if="
                  templateHook('filterSelectOptionsItemAfter', 'startDate', startDate)
                "
              ></div>
            </div>
          </div>
      ...
      <!-- <div class="embed-projects-filters-select" data-filter-type="instruments">
        ...
        <div
          class="embed-projects-filters-select-icon"
          :class="{ 'is-active': activeFilterSelect === 'instrument' }"
        ></div>
        ...
        <transition name="embed-projects-filters-select-options" mode="out-in">
          ...
          >
            ...
            >
              ...
              <div
                v-if="
                  templateHook('filterSelectOptionsItemAfter', 'instrument', instrument)
                "
              ></div>
            </div>
          </div>
      ...
      <!-- <div class="embed-projects-filters-select" data-filter-type="cooperations">
        ...
        >
          {{ $t("Kooperation", locale) }}
        </div>

        <div
          class="embed-projects-filters-select-icon"
          :class="{ 'is-active': activeFilterSelect === 'cooperation' }"
        ></div>
        ...
        <transition name="embed-projects-filters-select-options" mode="out-in">
          ...
          >
            <div
              ...
              @click.stop="
                clickToggleFilter({ type: 'cooperation', entity: cooperation })
              "
            >
              {{ translateField(cooperation, "name", locale) }}
              <div
                v-if="
                  templateHook('filterSelectOptionsItemAfter', 'cooperation', cooperation)
                "
              ></div>
            </div>
          </div>
      ...
      <div class="embed-projects-filters-select" data-filter-type="localWorkgroup">
        <div
          class="embed-projects-filters-select-label"
          @click.stop="clickFilterSelect('localWorkgroup')"
        >
          {{ $t("Lokale Arbeitsgruppe", locale) }}
        </div>
        <div
          class="embed-projects-filters-select-icon"
          :class="{ 'is-active': activeFilterSelect === 'localWorkgroup' }"
        ></div>
        <transition name="embed-projects-filters-select-options" mode="out-in">
          <div
            class="embed-projects-filters-select-options"
            v-if="activeFilterSelect === 'localWorkgroup'"
          >
            <div
              class="embed-projects-filters-select-options-item"
              v-for="workgroup in localWorkgroups"
              :class="{
                'is-selected': isFilterSelected({
                  type: 'localWorkgroup',
                  entity: workgroup,
              ...
              @click.stop="
                clickToggleFilter({ type: 'localWorkgroup', entity: workgroup })
              "
            >
              {{ workgroup.name }}
            </div>
      ...
      <div class="embed-projects-filters-select" data-filter-type="lePeriod">
        <div
          class="embed-projects-filters-select-label"
        ...
        <div
          class="embed-projects-filters-select-icon"
          :class="{ 'is-active': activeFilterSelect === 'lePeriod' }"
        ></div>
        <transition name="embed-projects-filters-select-options" mode="out-in">
          <div
            class="embed-projects-filters-select-options"
            v-if="activeFilterSelect === 'lePeriod'"
          >
            <div
              class="embed-projects-filters-select-options-item"
              v-for="period in leStructure"
              :class="{
                'is-selected': isFilterSelected({ type: 'lePeriod', entity: period }),
              }"
              @click.stop="handleLEPeriodChange(period)"
            >
              {{ period.name }}
            </div>
          </div>
      ...
      <div
        class="embed-projects-filters-select"
        data-filter-type="leFundingCategory"
        v-if="selectedPeriod"
      >
        <div
          class="embed-projects-filters-select-label"
          @click.stop="clickFilterSelect('leFundingCategory')"
        >
          {{ $t("LE Kategorie", locale) }}
        </div>
        <div
          class="embed-projects-filters-select-icon"
          :class="{ 'is-active': activeFilterSelect === 'leFundingCategory' }"
        ></div>
        <transition name="embed-projects-filters-select-options" mode="out-in">
          <div
            class="embed-projects-filters-select-options"
            v-if="activeFilterSelect === 'leFundingCategory'"
          >
            <div
              class="embed-projects-filters-select-options-item"
              ...
              @click.stop="handleLECategoryChange(category)"
            >
              {{ category.name }}
            </div>
          </div>
      ...
      <div
        class="embed-projects-filters-select"
        data-filter-type="leFundingArticle"
        v-if="selectedCategory"
      >
        <div
          class="embed-projects-filters-select-label"
          @click.stop="clickFilterSelect('leFundingArticle')"
        >
          {{ $t("LE Artikel", locale) }}
        </div>
        <div
          class="embed-projects-filters-select-icon"
          :class="{ 'is-active': activeFilterSelect === 'leFundingArticle' }"
        ></div>
        <transition name="embed-projects-filters-select-options" mode="out-in">
          <div
            class="embed-projects-filters-select-options"
            v-if="activeFilterSelect === 'leFundingArticle'"
          >
            <div
              class="embed-projects-filters-select-options-item"
              ...
              @click.stop="handleLEArticleChange(article)"
            >
              {{ article.name }}
            </div>
          </div>
      ...
      <div
        class="embed-projects-filters-select"
        data-filter-type="leFundingMethod"
        v-if="selectedArticle"
      >
        <div
          class="embed-projects-filters-select-label"
          @click.stop="clickFilterSelect('leFundingMethod')"
        >
          {{ $t("LE Methode", locale) }}
        </div>
        <div
          class="embed-projects-filters-select-icon"
          :class="{ 'is-active': activeFilterSelect === 'leFundingMethod' }"
        ></div>
        <transition name="embed-projects-filters-select-options" mode="out-in">
          <div
            class="embed-projects-filters-select-options"
            v-if="activeFilterSelect === 'leFundingMethod'"
          >
            <div
              class="embed-projects-filters-select-options-item"
              ...
              @click.stop="handleLEMethodChange(method)"
            >
              {{ method.name }}
            </div>
          </div>
    ...
    <transition name="embed-projects-map" mode="out-in">
      <div class="embed-projects-map" v-if="isMapEnabled">
        <ProjectsMap
          ...
          @clickCluster="clickMapCluster($event)"
        ></ProjectsMap>
      </div>
    </transition>
        ...
        >
          ...
          <div class="embed-projects-list-item-content">
            ...
            <p class="embed-projects-list-item-content-description">
              {{
                $helpers.textExcerpt(
                  $helpers.stripHTML(translateField(project, "description", locale)),
                  168,
                  "..."
                )
              }}
    ...
    <div class="embed-projects-actions" v-if="!isLoading">
      <div class="embed-projects-actions-item" v-if="!isLoadedFully">
        <a class="embed-projects-button" @click="clickLoadMore()" v-if="!isLoadingMore">{{
          $t("Mehr Projekte laden", locale)
        }}</a>
        <a class="embed-projects-button is-disabled" v-else>{{
          $t("Projekte werden geladen...", locale)
        }}</a>
      </div>
    </div>
...
export default {
    ...
    ...mapState({
      states: function (state) {
        return state.states.all
          ...
          .sort(
            this.$clientOptions?.middleware?.sortStates ||
              ((a, b) =>
                translateField(a, "name", this.locale).localeCompare(
                  translateField(b, "name", this.locale)
                ))
          );
      },
      topics: function (state) {
        return state.topics.all
          ...
          .sort(
            this.$clientOptions?.middleware?.sortTopics ||
      ...
      programs: function (state) {
        return state.programs.all
          ...
          .sort(
            this.$clientOptions?.middleware?.sortPrograms ||
              ((a, b) => a.position - b.position)
          );
      },
      instruments: function (state) {
        return state.instruments.all
          ...
          .filter(
            this.$clientOptions?.middleware?.filterInstruments || ((e) => e.isPublic)
          )
          .sort(
            this.$clientOptions?.middleware?.sortInstruments ||
              ((a, b) => a.position - b.position)
          );
      },
      localWorkgroups: function (state) {
        return state.localWorkgroups.all;
      },
      leStructure: function (state) {
        return state.leStructure.all;
      },
    }),
    ...mapGetters({
  ...
  methods: {
    ...
    handleLEPeriodChange(period) {
      ...
      this.clickToggleFilter({ type: "lePeriod", entity: period });
    },
    ...
    handleLECategoryChange(category) {
      ...
      this.selectedArticle = null;
      this.selectedMethod = null;
      this.clickToggleFilter({ type: "leFundingCategory", entity: category });
    },

    handleLEArticleChange(article) {
      this.selectedArticle = article;
      this.selectedMethod = null;
      this.clickToggleFilter({ type: "leFundingArticle", entity: article });
    },

    handleLEMethodChange(method) {
      this.selectedMethod = method;
      this.clickToggleFilter({ type: "leFundingMethod", entity: method });
    },

    clickToggleFilter(filter, remove = false) {
      this.activeFilterSelect = null;

      // Handle LE structure filters clearing their dependent filters
      if (filter.type === "lePeriod") {
        if (remove) {
          this.selectedPeriod = null;
        } else {
          this.selectedPeriod = filter.entity;
        }
        this.selectedCategory = null;
        this.selectedArticle = null;
        this.selectedMethod = null;
        ...
        if (remove) {
          ...
          this.selectedCategory = filter.entity;
        }
        this.selectedArticle = null;
        this.selectedMethod = null;
        ...
        if (remove) {
          ...
          this.selectedArticle = filter.entity;
        }
        this.selectedMethod = null;
        ...
        if (remove) {
          ...
          this.selectedMethod = filter.entity;
        }
      }
      ...
      if (remove) {
        ...
        if (
          this.$clientOptions?.mapboxApiToken &&
          filter.type === "program" &&
          filter.entity.name === "NRP"
        ) {
    ...
    isFilterSelected(filter) {
      return this.filters.some(
        (e) => e.type === filter.type && e.entity.id === filter.entity.id
      );
    },
    ...
    popState(event) {
      ...
      if (this.getUrlParams()["project-id"]) {
        this.$store
          .dispatch("projects/load", this.getUrlParams()["project-id"])
          .then((project) => {
            this.project = project;
          });
      }
    ...
    getHistoryQueryString(project) {
      ...
      if (project) {
        result.push(
          "project-id=" +
            project.id +
            "&title=" +
            encodeURIComponent(translateField(project, "title", this.locale))
        );
      }
      ...
      for (let filter of this.filters) {
        result.push(
          filter.type +
            "s[]=" +
            encodeURIComponent(translateField(filter.entity, "name", this.locale))
        );
      }
    ...
    applyFiltersFromUrlParameters() {
      ...
      ["state", "topic", "program", "startDate", "instrument", "cooperation"].forEach(
        (key) => {
          ...
          this.getUrlParams()[key + "s"].forEach((f) => {
            let entity = this[collection].find(
              (e) =>
                e.id === f || e.name === f || translateField(e, "name", this.locale) === f
            );
  ...
  created() {
    ...
    Promise.all([
      ...
      if (
        this.$clientOptions?.mapboxApiToken &&
        this.filters.find(
          (filter) => filter.type === "program" && filter.entity.name === "NRP"
        )
      ) {
        this.isMapEnabled = true;
      }
...
.embed-projects-filters-list-item {
  color: white;
}

.embed-projects-filters-select-options-item.is-selected {
  color: white;
}
