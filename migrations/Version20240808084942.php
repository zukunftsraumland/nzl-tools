 ...
 */
final class Version20240808084942 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE pv_project ADD local_workgroup_id INT DEFAULT NULL, ADD cooperation_project_id INT DEFAULT NULL, ADD case_study TINYINT(1) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE pv_project DROP local_workgroup_id, DROP cooperation_project_id, DROP case_study');
    }
}
